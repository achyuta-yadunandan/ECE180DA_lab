...
a. If in State 1, then +V is needed at Phase A, GND is needed at Phase B, and Float is

needed at Phase C

b. If in State 3, then GND is needed at Phase A, Float is needed at Phase B, and +V is
...
commutation diagram, Phase\_A needs to be +V (or equivalently +VDD), Phase\_B needs to be GND, and

Phase\_C needs to be Float.
...
creating a short from +VDD to Phase\_A, and Q2 turns off creating an open (R ~ infinity)

from GND to Phase\_A. The result is that Phase\_A is now +VDD.
